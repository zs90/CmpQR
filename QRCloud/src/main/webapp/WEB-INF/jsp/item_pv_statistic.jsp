...
<body>
<div id="upper_nav_bar" style='text-align:center;'><p style="font-size:25px; margin:0px; padding:15px 0 0 0;">资源:${name}</p></div>
...
$(document).ready(function(){ 
    ...
    $("#submit").click(function(){
    	...
    	$.ajax({
    		url:'GetItemPVDetail.do?startDate=' + $( "#datepicker1" ).val() + '&' + 'endDate=' + $( "#datepicker2" ).val(),
    		async:false,
    		type:'get',
    		dataType:'json',
