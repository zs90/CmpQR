...
public class ProjectController {
	...
	@RequestMapping(value="/GetProjectList.do", method=RequestMethod.POST, produces = "text/plain; charset=UTF-8")
	@ResponseBody
	...
	@RequestMapping(value="/CheckProject.do", method=RequestMethod.POST, produces = "text/plain; charset=UTF-8")
	@ResponseBody
	...
	public void batchDownloadQR(@RequestParam(value="project_id") String projectId, HttpServletResponse response){
		try{
			...
			//String out = srcPath + "/" + current_project + ".zip";
	...
	@RequestMapping(value="/getCheckLog.do", method=RequestMethod.POST, produces = "text/plain; charset=UTF-8")
	@ResponseBody
	...
	@ResponseBody
	public String searchProject(String projectName, HttpSession session, int checkStatus){
		String userName = (String)session.getAttribute("username");
		int userGroup = (int)session.getAttribute("usergroup");
		
		List<Project> projectList = projectService.getProjects(projectName, userGroup, userName, checkStatus);
	...
	@RequestMapping(value="/GetProjectPVDetail.do", method=RequestMethod.GET, produces = "text/plain; charset=UTF-8")
	@ResponseBody
